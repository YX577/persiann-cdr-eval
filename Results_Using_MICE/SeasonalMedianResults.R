...
#*[-----------------------------------------------------------------------------------------------]*#
#*[ Objective: This R program reads PERSIANN-CDR seasonal median precipitation data and           ]*#
...
df <- read.table(file="~/data/seasonalMedian.txt", header = TRUE)
...
# for target point & 8 surrounding points after
# called with foreach()
#  ___________
# |   |   |   |
# |___|___|___|
